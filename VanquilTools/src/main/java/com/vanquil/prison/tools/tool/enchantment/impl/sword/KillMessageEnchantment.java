...
public final class KillMessageEnchantment implements ToolEnchantment,
    ...
    public static class Config {
        final String displayName = "&cKill Message";
        final String description = "&7Display a funny kill message in the chat when you murder someone.";
        transient final EnumeratedDistribution<String> distro;
        final Map<String, Double> deathMessages = new HashMap<>();

        public Config() {
            deathMessages.put("{0} took a massive L while fighting {1}.", 0.2);
            deathMessages.put("{0} got scared while fighting {1}.", 0.2);
            deathMessages.put("{0} dropped his sword while running away from {1}.", 0.2);
            deathMessages.put("{0} forgot how to Minecraft upon seeing {1}.", 0.2);
            deathMessages.put("{0} gave up mid-fight with {1}.", 0.2);
